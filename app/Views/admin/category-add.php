                        ...
                        <div class="card">
                            <div class="card-body p-5">
                                ...
                                <div class="mb-4"><label for="form-category/name" class="form-label">Name</label><input
                                        type="text" class="form-control" id="form-category/name" value="Hand Tools" />
                                </div>
                        ...
                        <div class="card w-100 mt-5">
                            <div class="card-body p-5">
                                ...
                                <div class="border p-4 d-flex justify-content-center">
                                    <div class="max-w-20x"><img
                                            src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>images/products/product-7-320x320.jpg"
                                            class="w-100 h-auto" width="320" height="320" alt="" /></div>
                                </div>
                                <div class="mt-4 mb-n2"><a href="#" class="me-3 pe-2">Replace image</a><a href="#"
                                        class="text-danger me-3 pe-2">Remove image</a></div>
                            </div>
                        </div>
                    </div>
                </div>

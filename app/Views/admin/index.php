    ...
    <div class="container pb-6">
        <div class="py-5">
            <div class="row g-4 align-items-center">
                ...
                <form action="<?php echo url('admin/getorderdate'); ?>" method="post" enctype="multipart/form-data">
                    <div class="col-auto d-flex">
                        <select name="order_date" class="form-select me-3">
                            <option value="all">all
                            </option>
                            <?php if (is_array($data['dates']) || is_object($data['dates'])) :
                                foreach ($data['dates'] as $date) : ?>
                            <option
                                <?php echo (isset($data['selected']) && $data['selected'] == $date['order_date']) ? 'selected' : ''; ?>
                                value="<?php echo $date['order_date']; ?>"><?php echo $date['order_date']; ?></option>
                            <?php endforeach;
                            else : ?>
                            <?php endif; ?>
                        </select>

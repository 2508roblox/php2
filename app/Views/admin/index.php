    ...
    <div class="container pb-6">
        <div class="py-5">
            <div class="row g-4 align-items-center">
                ...
                <div class="col-auto d-flex"><select name="order_date" class="form-select me-3">
                        <form action="<?php url('admin/getorderdate') ?>" method="get" enctype="multipart/form-data">

                            <?php

                            if (is_array($data['dates']) || is_object($data['dates'])) : ?>
                                <?php foreach ($data['dates'] as $date) :
                                ?>
                                    <option value="<?php echo $date['order_date'] ?>"><?php echo $date['order_date'] ?></option>

                                <?php endforeach; ?>
                            <?php else : ?>

                            <?php endif; ?>
                    </select><a href type="submit" class="btn btn-primary">Export</a></div>
                </form>
            </div>
        </div>
        <div class="row g-4 g-xl-5">
            <div class="col-12 col-md-4 d-flex">
                <div class="card saw-indicator flex-grow-1" data-sa-container-query="{&quot;340&quot;:&quot;saw-indicator--size--lg&quot;}">
                    ...
                    <div class="saw-indicator__body">
                        ...
                        <div class="saw-indicator__value"><?php Format::currency($subtotal) ?></div>
            ...
            <div class="col-12 col-md-4 d-flex">
                <div class="card saw-indicator flex-grow-1" data-sa-container-query="{&quot;340&quot;:&quot;saw-indicator--size--lg&quot;}">
                    ...
                    <div class="saw-indicator__body">
                        <div class="saw-indicator__value"><?php Format::currency($subtotal / $i) ?></div>
            ...
            <div class="col-12 col-md-4 d-flex">
                <div class="card saw-indicator flex-grow-1" data-sa-container-query="{&quot;340&quot;:&quot;saw-indicator--size--lg&quot;}">
                    ...
                    <div class="saw-indicator__body">
                        <div class="saw-indicator__value"><?php echo $i ?></div>
                        <div class="saw-indicator__delta saw-indicator__delta--rise">
                            <div class="saw-indicator__delta-direction"><svg xmlns="http://www.w3.org/2000/svg" width="9" height="9" viewBox="0 0 9 9" fill="currentColor">
                                    <path d="M9,0L8,6.1L2.8,1L9,0z"></path>
                                    <circle cx="1" cy="8" r="1"></circle>
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>vendor/flag-icons/24/IT.png" class="sa-language-icon d-block" alt="" title="Italy" /></td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>vendor/flag-icons/24/DE.png" class="sa-language-icon d-block" alt="" title="Germany" /></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="app-customer.html" class="sa-symbol sa-symbol--shape--circle sa-symbol--size--md me-3">
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>vendor/flag-icons/24/US.png" class="sa-language-icon d-block" alt="" title="USA" /></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="app-customer.html" class="sa-symbol sa-symbol--shape--circle sa-symbol--size--md me-3">
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>vendor/flag-icons/24/CO.png" class="sa-language-icon d-block" alt="" title="Columbia" /></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="app-customer.html" class="sa-symbol sa-symbol--shape--circle sa-symbol--size--md me-3">
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>vendor/flag-icons/24/RS.png" class="sa-language-icon d-block" alt="" title="Srbija" /></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="app-customer.html" class="sa-symbol sa-symbol--shape--circle sa-symbol--size--md me-3">
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>vendor/flag-icons/24/FR.png" class="sa-language-icon d-block" alt="" title="France" /></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="app-customer.html" class="sa-symbol sa-symbol--shape--circle sa-symbol--size--md me-3">
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>vendor/flag-icons/24/RU.png" class="sa-language-icon d-block" alt="" title="Russia" /></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="app-customer.html" class="sa-symbol sa-symbol--shape--circle sa-symbol--size--md me-3">
                    ...
                    <ul class="list-group list-group-flush">
                            ...
                            <div class="d-flex align-items-center py-3">
                                <a href="app-product.html" class="me-4">
                                    <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                        <img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>images/products/product-1-40x40.jpg" width="40" height="40" alt="" />
                                    </div>
                                </a>
                        ...
                        <li class="list-group-item py-2">
                            <div class="d-flex align-items-center py-3">
                                <a href="app-product.html" class="me-4">
                                    <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                        <img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>images/products/product-7-40x40.jpg" width="40" height="40" alt="" />
                                    </div>
                                </a>
                                <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                                    <div class="col"><a href="app-product.html" class="text-reset fs-exact-14">Electric
                                            ...
                                            300 Watts</a>
                                        <div class="text-muted fs-exact-13">Reviewed by <a href="app-customer.html" class="text-reset">Adam Taylor</a>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-auto">
                        ...
                        <li class="list-group-item py-2">
                            <div class="d-flex align-items-center py-3">
                                <a href="app-product.html" class="me-4">
                                    <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                        <img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>images/products/product-10-40x40.jpg" width="40" height="40" alt="" />
                                    </div>
                                </a>
                                <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                                    <div class="col"><a href="app-product.html" class="text-reset fs-exact-14">Water
                                            Tap</a>
                                        <div class="text-muted fs-exact-13">Reviewed by <a href="app-customer.html" class="text-reset">Jessica
                                                Moore</a></div>
                                    </div>
                                    <div class="col-12 col-sm-auto">
                        ...
                        <li class="list-group-item py-2">
                            <div class="d-flex align-items-center py-3">
                                <a href="app-product.html" class="me-4">
                                    <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                        <img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>images/products/product-5-40x40.jpg" width="40" height="40" alt="" />
                                    </div>
                                </a>
                                <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                                    <div class="col"><a href="app-product.html" class="text-reset fs-exact-14">Brandix
                                            Router Power Tool
                                            2017ERXPK</a>
                                        <div class="text-muted fs-exact-13">Reviewed by <a href="app-customer.html" class="text-reset">Helena
                                                Garcia</a></div>
                                    </div>
                                    <div class="col-12 col-sm-auto">
                                        <div class="sa-rating ms-sm-3 my-2 my-sm-0" style="--sa-rating--value:0.6">
                        ...
                        <li class="list-group-item py-2">
                            <div class="d-flex align-items-center py-3">
                                <a href="app-product.html" class="me-4">
                                    <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                        <img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>images/products/product-2-40x40.jpg" width="40" height="40" alt="" />
                                    </div>
                                </a>
                                <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                        ...
                        <li class="list-group-item py-2">
                            <div class="d-flex align-items-center py-3">
                                <a href="app-product.html" class="me-4">
                                    <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                        <img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>images/products/product-16-40x40.jpg" width="40" height="40" alt="" />
                                    </div>
                                </a>
                                <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                                    <div class="col"><a href="app-product.html" class="text-reset fs-exact-14">Brandix
                                            Screwdriver SCREW150</a>
                                        <div class="text-muted fs-exact-13">Reviewed by <a href="app-customer.html" class="text-reset">Charlotte
                                                Jones</a></div>
                                    </div>
                                    <div class="col-12 col-sm-auto">
                                        <div class="sa-rating ms-sm-3 my-2 my-sm-0" style="--sa-rating--value:0.8">

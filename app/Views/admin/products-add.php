            ...
            <div class="container">
                <div class="py-5">
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-auto d-flex"><a href="#" class="btn btn-secondary me-3">Duplicate</a><button
                                href="#" type="submit" class="btn btn-primary">Save</button></div>
                    </div>
                </div>
                    ...
                    <div class="sa-entity-layout__body">
                        <div class="sa-entity-layout__main">
                            <div class="card">
                                <div class="card-body p-5">
                                    ...
                                    <div class="mb-4"><label for="form-product/name"
                                            ...
                                            id="form-product/name" name="name" value="Brandix Screwdriver SCREW150" />
                                    </div>
                                    <div class="mb-4"><label for="form-product/slug" class="form-label">Slug</label>
                                        <div class="input-group input-group--sa-slug"><span class="input-group-text"
                                                ...
                                                name="slug" type="text" class="form-control" id="form-product/slug"
                                    ...
                                    <div class="mb-4"><label for="form-product/description"
                                            ...
                                            id="form-product/description" name="description"
                                    ...
                                    <div><label for="form-product/short-description" class="form-label">Short
                                            description</label><textarea name="small_description"
                                            id="form-product/short-description" class="form-control"
                                            rows="2"></textarea></div>
                                </div>
                            </div>
                            <div class="card mt-5">
                                <div class="card-body p-5">
                                    ...
                                    <div class="row g-4">
                                        <div class="col"><label for="form-product/price"
                                                ...
                                                class="form-control" id="form-product/price" value="1499" /></div>
                                        <div class="col"><label for="form-product/old-price" class="form-label">Old
                                                price</label><input name="promotion_price" type="number"
                            ...
                            <div class="card mt-5">
                                <div class="card-body p-5">
                                    <div class="mb-4 pt-2">
                                        <label class="form-check"><input type="checkbox" checked
                                                class="form-check-input" name="feature">
                            ...
                            <div class="card mt-5">
                                <div class="card-body p-5">
                                    ...
                                    <div><label for="form-product/quantity" class="form-label">Stock
                                            ...
                                            id="form-product/quantity" value="18" name="quantity" />
                                    </div>
                                </div>
                            </div>
                            <div class="card mt-5">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div
                                                            ...
                                                            <img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>images/products/product-16-1-40x40.jpg"
                            ...
                            <div class="card mt-5">
                                <div class="card-body p-5">
                                    ...
                                    <div class="mb-4"><label for="form-product/seo-title" class="form-label">Page
                                            title</label><input name="meta_keyword" type="text" class="form-control"
                                    ...
                                    <div><label for="form-product/seo-description" class="form-label">Meta
                                            ...
                                            id="form-product/seo-description" class="form-control" rows="2"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>

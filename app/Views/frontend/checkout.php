                    ...
                    <div class="col-xl-4 side-bar">
                        ...
                        <div class="order-detail sticky-top">
                            ...
                            <div class="cart-item style-1">
                                <div class="dz-media">
                                    <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/shop/shop-cart/pic1.jpg"
                                        alt="/">
                                </div>
                                <div class="dz-content">
                                    <h6 class="title mb-0"><?php echo $cart['product_name'] ?> x
                                        <?php echo $cart['quantity'] ?></h6>
                                    <span class="price">
                                    ...
                                    <tr class="title">
                                        <td>
                                            <h6 style="display: flex; justify-content:space-between; align-items: center;"
                                                class="title font-weight-500">Phí vận chuyển
                                                <img src="https://pito.vn/wp-content/uploads/2022/12/Logo-Giao-hang-nhanh-moi.webp"
                                                    width="30px" alt="">

                                            </h6>
                                            <span class="font-italic"
                                                style="font-style: italic; color: gray; font-size: small;">Api giao hàng
                                                nhanh </span>
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr class="shipping">
                                        <td>
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <input hidden type="text" id="shipping_cost_input" name="shipping_price"
                                                    value="" id="flexRadioDefault2">

                                            </div>
                                        </td>
                                        <td style="color:red" class="price" id="shipping_cost">*vui lòng chọn địa chỉ
                                        </td>
                                    </tr>
                                    <tr class="shipping">
                                        <td>
                                        ...
                                        <input type="hidden" id="discount_input" name="discount"
                                            value="<?php echo Session::get('coupon') ?>">

                                    </tr>
                                    <tr class="total">
                                        <td>Total</td>
                                        <td class="price" id="total_price_text">
                                            <?php Format::currency($subtotal - Session::get('coupon')) ?> </td>
                            ...
                            <div class="accordion dz-accordion accordion-sm" id="accordionFaq1">
                                    ...
                                    <div class="accordion-header" id="heading1">
                                        <div class="accordion-button collapsed custom-control custom-checkbox"
                                            ...
                                            <input class="form-check-input radio" type="radio" name="payment_method"
                                                value="momo" id="flexRadioDefault3">
                                ...
                                <div class="accordion-item">
                                    <div class="accordion-header" id="heading2">
                                        <div class="accordion-button collapsed custom-control custom-checkbox"
                                            ...
                                            <input class="form-check-input radio" type="radio" name="payment_method"
                                                value="vietinbank" id="flexRadioDefault10">
                                            <label class="form-check-label" for="flexRadioDefault10">
                                                VietinBank
                                            </label>
                                            <img src="https://i.pinimg.com/564x/0e/33/49/0e3349ab85ae5ebf604df3cb380f9c8f.jpg"
                                                width="30px" alt="">
                                        </div>
                                    </div>
                                ...
                                <div class="accordion-item">
                                    <div class="accordion-header" id="heading3">
                                        <div class="accordion-button collapsed custom-control custom-checkbox"
                                            ...
                                            <input class="form-check-input radio" type="radio" name="payment_method"
                                                value="vnpay" id="flexRadioDefault11">
                                ...
                                <div class="accordion-item">
                                    <div class="accordion-header" id="heading4">
                                        <div class="accordion-button collapsed custom-control custom-checkbox"
                                            data-bs-toggle="collapse" data-bs-target="#collapse4" role="navigation"
                                            aria-expanded="false" aria-controls="collapse4">
                                            <input class="form-check-input radio" checked type="radio"
                                                name="payment_method" value="cash" id="flexRadioDefault5">
                                ...
                                <div class="accordion-item">
                                    <div class="accordion-header" id="heading5">
                                        <div class="accordion-button collapsed custom-control custom-checkbox"
                                            data-bs-toggle="collapse" data-bs-target="#collapse5" role="navigation"
                                            aria-expanded="false" aria-controls="collapse5">
                                            <input class="form-check-input radio" type="radio" name="payment_method"
                                                value="paypal" id="flexRadioDefault4">
                                            <label class="form-check-label" for="flexRadioDefault4">
                                                Paypal
                                            </label>
                                            <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/shop/payment.jpg"
                                                alt="/">

                     ...
                     <div class="table-responsive">
                         <table class="table check-tbl style-1">
                             ...
                             <tbody>
                                 ...
                                 <?php if (is_array($data['orders']) || is_object($data['orders'])) : ?>
                                 <?php foreach ($data['orders'] as $order) : ?>
                                 <tr>

                                     <td class="product-item-name">
                                         <a href="<?php echo url('order/orderdetail/' . $order['id']); ?>">
                                             #<?php echo $order['id']; ?>
                                         </a>
                                     </td>
                                     <td class="product-item-name"><?php echo $order['status']  ?></td>
                                     <td class="product-item-name"><?php echo $order['payment_mode']  ?></td>
                                     <td class="product-item-name"> <?php Format::currency($order['total_amount'])  ?>
                                     </td>
                                     <td class="product-item-name"><?php echo $order['created_at']  ?></td>

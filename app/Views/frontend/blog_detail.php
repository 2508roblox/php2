				...
				<div class="row justify-content-center">
					<div class="col-xl-8 col-lg-8">
						...
						<div class="dz-blog blog-single style-1 sidebar">
							...
							<div class="dz-media">
								<img src="<?php echo ASSETS_URL_ROOT . '/client_assets/'?>images/blog/detail/pic1.jpg" alt="/">
							</div>
							<div class="dz-info">
								<div class="dz-post-text">
									...
									<figure class="wp-container-5 wp-block-gallery-3 wp-block-gallery has-nested-images columns-3 is-cropped">
										<figure class="wp-block-image size-large"><img src="<?php echo ASSETS_URL_ROOT . '/client_assets/'?>images/blog/blogpost-3/pic1.jpg" alt="/"></figure>
										<figure class="wp-block-image size-large"><img src="<?php echo ASSETS_URL_ROOT . '/client_assets/'?>images/blog/blogpost-3/pic2.jpg" alt="/"></figure>
										<figure class="wp-block-image size-large"><img src="<?php echo ASSETS_URL_ROOT . '/client_assets/'?>images/blog/blogpost-3/pic3.jpg" alt="/"></figure>
										<figure class="wp-block-image size-large"><img src="<?php echo ASSETS_URL_ROOT . '/client_assets/'?>images/blog/blogpost-3/pic4.jpg" alt="/"></figure>
										<figure class="wp-block-image size-large"><img src="<?php echo ASSETS_URL_ROOT . '/client_assets/'?>images/blog/blogpost-3/pic1.jpg" alt="/"></figure>
									</figure>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
						...
						<div class="author-box style-1">
							<div class="author-profile-info">
								<div class="author-profile-pic">
									<img src="<?php echo ASSETS_URL_ROOT . '/client_assets/'?>images/blog/profile.jpg" alt="/">
								</div>
							...
							<div class="row">
								<div class="col-lg-6 col-md-6 m-b30">
									<div class="dz-card style-5 light">
										<div class="dz-media">
											<img src="<?php echo ASSETS_URL_ROOT . '/client_assets/'?>images/blog/blogpost-5/pic1.jpg" alt="/">
										</div>
										<div class="dz-info">
											<div class="dz-meta">
												<ul>
											...
											<a href="<?php url('blog/detail/123')?>" class="font-14 read-btn">Read More 
								...
								<div class="col-lg-6 col-md-6 m-b30">
									<div class="dz-card style-5 light">
										<div class="dz-media">
											<img src="<?php echo ASSETS_URL_ROOT . '/client_assets/'?>images/blog/blogpost-5/pic2.jpg" alt="/">
										</div>
										<div class="dz-info">
											<div class="dz-meta">
												<ul>
							...
							<div class="widget recent-posts-entry">
								...
								<div class="widget-post-bx">
									<div class="widget-post clearfix">
										<div class="dz-media"> 
											<a href="<?php url('blog/detail/123')?>"><img src="<?php echo ASSETS_URL_ROOT . '/client_assets/'?>images/blog/recent-blog/pic1.jpg" alt="/"></a>
										</div>
										<div class="dz-info">
											<div class="dz-meta">
												<ul>
											...
											<h6 class="title"><a href="<?php url('blog/detail/123')?>">Uncovering the Beauty Benefits of Plant-Based Skincare</a></h6>
										</div>
									</div>
									<div class="widget-post clearfix">
										<div class="dz-media"> 
											<a href="<?php url('blog/detail/123')?>"><img src="<?php echo ASSETS_URL_ROOT . '/client_assets/'?>images/blog/recent-blog/pic2.jpg" alt="/"></a>
										</div>
										<div class="dz-info">
											<div class="dz-meta">
												<ul>
											...
											<h6 class="title"><a href="<?php url('blog/detail/123')?>">Harness the Power of Plants for Healthy Glowing Skin</a></h6>
										</div>
									</div>
									<div class="widget-post clearfix">
										<div class="dz-media"> 
											<a href="<?php url('blog/detail/123')?>"><img src="<?php echo ASSETS_URL_ROOT . '/client_assets/'?>images/blog/recent-blog/pic3.jpg" alt="/"></a> 
										</div>
										<div class="dz-info">
											<div class="dz-meta">
												<ul>
											...
											<h6 class="title"><a href="<?php url('blog/detail/123')?>">Embrace the Revitalizing Benefits of Plant-Based Product</a></h6>
										</div>
									</div>
								</div>
							</div>

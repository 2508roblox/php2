...
<head>
	...
	<link rel="stylesheet" type="text/css" href="icons/feather/css/iconfont.css">
								...
								<aside>
									...
									<div class="widget">
										...
										<div class="d-flex align-items-center flex-wrap color-filter ps-2">
											...
											<div class="form-check">
												<input class="form-check-input" type="radio" name="radioNoLabel" id="radioNoLabel10" value="#ADCFA7" aria-label="...">
												<span></span>
											</div>
										</div>
									</div>
														...
														<div class="rate">
															<div class="d-flex align-items-center mb-xl-3 mb-2">
																...
																<div class="meta-content">
																	...
																	<div class="d-flex align-items-center color-filter">
																		<div class="form-check">
																			<input class="form-check-input" type="radio" name="radioNoLabel" id="radioNoLabel20" value="#24262B" aria-label="..." checked>
																			<span></span>
																		</div>
																		<div class="form-check">
																			<input class="form-check-input" type="radio" name="radioNoLabel" id="radioNoLabel21" value="#8CB2D1" aria-label="...">
																			<span></span>
																		</div>
																		<div class="form-check">
																			<input class="form-check-input" type="radio" name="radioNoLabel" id="radioNoLabel22" value="#0D775E" aria-label="...">
																			<span></span>
																		</div>
																	</div>
																</div>

											...
											<div class="col-md-6 col-sm-6">
												<div class="banner-media">
													<div class="img-preview" data-swiper-parallax="-100">
														<img src="<?php echo ASSETS_URL_ROOT . '/public/upload/' ?><?php echo isset($slide['product_image']) && $slide['product_image'] !== '' ? $slide['product_image'] : 'empty-img.png'; ?>" alt="banner-media">
													</div>
												</div>
											</div>
										</div>

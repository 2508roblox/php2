								...
								<div class="shop-sidebar-cart">
									<ul class="sidebar-cart-list">
										...
										<li>
											<div class="cart-widget">
												<div class="dz-media me-3">
													<img src="<?php echo ASSETS_URL_ROOT . '/client_assets/'?>images/shop/shop-cart/pic3.jpg" alt="">
												</div>
												<div class="cart-content">
									...
									<div class="col-md-6 col-sm-6 align-self-center">
										<div class="swiper-content">
											<div class="content-info">
												<h1 class="title mb-2" data-swiper-parallax="-20">Natural Wooden Products</h1>
												<p class="text mb-0" data-swiper-parallax="-40">Sell globally in minutes with localized currencies, languages, and experiences in every market.</p>
									...
									<div class="col-md-6 col-sm-6">
										<div class="banner-media">
											<div class="img-preview" data-swiper-parallax="-100">
												<img src="<?php echo ASSETS_URL_ROOT . '/client_assets/'?>images/banner/banner-media.png" alt="banner-media">
											</div>
										</div>
									</div>
								</div>
							...
							<div class="banner-content">
								<div class="row gx-0">
									<div class="col-md-6 col-sm-6 align-self-center">
										<div class="swiper-content">
											<div class="content-info">
												<h1 class="title mb-2" data-swiper-parallax="-20">Explore Wooden Products</h1>
												<p class="text mb-0" data-swiper-parallax="-40">Sell globally in minutes with localized currencies, languages, and experiences in every market.</p>
									...
									<div class="col-md-6 col-sm-6">
										<div class="banner-media">
											<div class="img-preview" data-swiper-parallax="-100">
												<img src="<?php echo ASSETS_URL_ROOT . '/client_assets/'?>images/banner/banner-media-2.png" alt="banner-media">
											</div>
										</div>
									</div>
								</div>
				...
				<div class="container">
					...
					<div class="clearfix">
						<ul id="masonry" class="row g-xl-4 g-3">
							...
							<li class="card-container col-6 col-xl-3 col-lg-3 col-md-4 col-sm-6 Bottle wow fadeInUp" data-wow-delay="0.3s">
								<div class="shop-card">
									<div class="dz-media">
										<img src="<?php echo ASSETS_URL_ROOT . '/client_assets/'?>images/shop/product/3.png" alt="image">
										<div class="shop-meta">
							...
							<li class="card-container col-6 col-xl-3 col-lg-3 col-md-4 col-sm-6 Begs wow fadeInUp" data-wow-delay="0.4s">
								<div class="shop-card">
									<div class="dz-media">
										<img src="<?php echo ASSETS_URL_ROOT . '/client_assets/'?>images/shop/product/4.png" alt="image">
										<div class="shop-meta">
							...
							<li class="card-container col-6 col-xl-3 col-lg-3 col-md-4 col-sm-6 Bottle wow fadeInUp" data-wow-delay="0.5s">
								<div class="shop-card">
									<div class="dz-media">
										<img src="<?php echo ASSETS_URL_ROOT . '/client_assets/'?>images/shop/product/5.png" alt="image">
										<div class="shop-meta">
							...
							<li class="card-container col-6 col-xl-3 col-lg-3 col-md-4 col-sm-6 Toothbrushes wow fadeInUp" data-wow-delay="0.6s">
								<div class="shop-card">
									<div class="dz-media">
										<img src="<?php echo ASSETS_URL_ROOT . '/client_assets/'?>images/shop/product/6.png" alt="image">
										<div class="shop-meta">
							...
							<li class="card-container col-6 col-xl-3 col-lg-3 col-md-4 col-sm-6 Bottle wow fadeInUp" data-wow-delay="0.7s">
								<div class="shop-card">
									<div class="dz-media">
										<img src="<?php echo ASSETS_URL_ROOT . '/client_assets/'?>images/shop/product/7.png" alt="image">
										<div class="shop-meta">
							...
							<li class="card-container col-6 col-xl-3 col-lg-3 col-md-4 col-sm-6 Begs wow fadeInUp" data-wow-delay="0.8s">
								<div class="shop-card">
									<div class="dz-media">
						...
						<div class="dz-card style-1 d-lg-block d-md-flex d-sm-flex d-block">
							...
							<div class="dz-info">
								...
								<h3 class="dz-title mb-md-3 mb-sm-5 m-b10">
									<a href="blog-dark-2-column.html">Uncovering The Benefits of Wooden Based Furniture</a>
								</h3>
							...
							<div class="col-xl-12 col-lg-12 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
								<div class="dz-card blog-half style-5 m-b30">
									...
									<div class="dz-info">
										...
										<h4 class="dz-title">
											<a href="blog-dark-half-image.html">Explore The Benefits of Wooden Utensils In DailyLife</a>
										</h4>
							...
							<div class="col-xl-12 col-lg-12 col-sm-6 wow fadeInUp" data-wow-delay="0.4s">
								<div class="dz-card blog-half style-5 m-b30">
									...
									<div class="dz-info">
										...
										<h4 class="dz-title">
											<a href="blog-dark-half-image.html">With Wooden Comb Makes Your Hairs More Beautiful and Clean</a>
										</h4>
										<a href="blog-dark-half-image.html" class="font-14 read-btn">Read More 
											<i class="icon feather icon-chevron-right"></i>
										</a>

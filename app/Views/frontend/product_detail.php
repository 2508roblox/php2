                                ...
                                <div class="swiper-wrapper" id="lightgallery">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="dz-media DZoomImage">
                                            ...
                                            <img src="<?php echo ASSETS_URL_ROOT . '/public/upload/' ?><?php echo $productImage['image']; ?>"
                                                alt="image">
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                                    ...
                                    <div class="dz-content-footer">
                                        <div class="dz-content-start">
                                            ...
                                            <h4 class="title mb-1"><a
                                                    href="<?php url('products/detail/123') ?>"><?php echo $productDetail['name']; ?></a>
                                            </h4>
                        ...
                        <div class="col-xl-5">
                            <div class="cart-detail">
                                ...
                                <a href="<?php url('cart') ?>" class="btn btn-secondary w-100">ADD TO CART</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row g-lg-4 g-3">
                                <div class="col-xl-4 col-md-4 col-sm-4 col-6">
                                    <div class="related-img dz-media">
                                        <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/feature/product-feature/1.png"
                                            alt="/">
                                    </div>
                                </div>
                                <div class="col-xl-4 col-md-4 col-sm-4 col-6">
                                    <div class="related-img dz-media">
                                        <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/feature/product-feature/2.png"
                                            alt="/">
                                    </div>
                                </div>
                                <div class="col-xl-4 col-md-4 col-sm-4">
                                    <div class="related-img dz-media">
                                        <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/feature/product-feature/3.png"
                                            alt="/">
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <ol class="comment-list">
                                            <li class="comment even thread-even depth-1 comment" id="comment-2">
                                                <div class="comment-body">
                                                    <div class="comment-author vcard">
                                                        <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/profile4.jpg"
                                                            alt="/" class="avatar">
                                                ...
                                                <ol class="children">
                                                    <li class="comment byuser comment-author-w3itexpertsuser bypostauthor odd alt depth-2 comment"
                                                        ...
                                                        <div class="comment-body" id="div-comment-3">
                                                            <div class="comment-author vcard">
                                                                <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/profile3.jpg"
                                                                    alt="/" class="avatar">
                                            ...
                                            <li class="comment even thread-odd thread-alt depth-1 comment"
                                                ...
                                                <div class="comment-body" id="div-comment-4">
                                                    <div class="comment-author vcard">
                                                        <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/profile2.jpg"
                                                            alt="/" class="avatar">
                                    ...
                                    <div class="default-form comment-respond style-1" id="respond">
                                        ...
                                        <div class="clearfix">
                                            <form method="post" id="comments_form" class="comment-form" novalidate>
                                                <p class="comment-form-author"><input id="name" placeholder="Author"
                                                        name="author" type="text" value=""></p>
                                                <p class="comment-form-email"><input id="email" required="required"
                                                        placeholder="Email" name="email" type="email" value=""></p>
    ...
    <section class="content-inner-1 overlay-white-middle overflow-hidden">
        <div class="container">
            <div class="section-head style-2">
                ...
                <a href="<?php url('products/detail/123') ?>"
                    class="text-secondary font-14 d-flex align-items-center gap-1">See all products

         ...
         <div class="main-bar clearfix">
             <div class="container-fluid clearfix">
                 ...
                 <div class="logo-header me-5">
                     <a href="index.html">
                         <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/logo.png" alt="logo" class="logo-dark">
                         <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/logo.png" alt="logo" class="logo-light">
                     </a>
                 </div>
                 <!-- EXTRA NAV -->
                 <div class="extra-nav">
...
">
                                 <?php
                                    ...
                                    ?>
                                     ...
                                     <a href="<?php url('auth/logout') ?>" style="display: flex; align-items: center">
                                         <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="red" height="14px" width="14px" version="1.1" id="Capa_1" viewBox="0 0 384.971 384.971" xml:space="preserve">
                                             <g>
                                                 <g id="Sign_Out">
     ...
     <div class="dz-search-area dz-offcanvas offcanvas offcanvas-top" tabindex="-1" id="offcanvasTop">
         ...
         <div class="container">
             <form class="header-item-search" method="post" action="<?php echo url('shop/search') ?>" enctype="multipart/form-data">
                 <div class="input-group search-input">
                     <select class="default-select" style="z-index: 99 !important;">
                         <option value="0">All Categories</option>

                     </select>
                     <input type="text" class="form-control" name="search" aria-label="Text input with dropdown button" placeholder="Search Product">
                                             ...
                                             <li>
                                                 <div class="cart-widget">
                                                     <div class="dz-media me-3">
                                                         <img src="<?php echo ASSETS_URL_ROOT . '/public/upload/' . $cart['product_image']; ?>" alt="">
                                                     </div>
                                                     <div class="cart-content">
                                                         <h6 class="title"><a href="product-thumbnail.html"><?php echo $cart['product_name']; ?></a>
                                                         </h6>
                                                     ...
                                                     <a href="<?php echo url('cart/delete/' . $cart['id']); ?>" class="dz-close">
                                                         <i class="ti-close"></i>
                                                     </a>
                                                 </div>
                                             </li>
                                        ...
                                        if (is_array($_SESSION['wishlists']) || is_object($_SESSION['wishlists'])) : ?>
                                         <?php foreach ($_SESSION['wishlists'] as $wishlist) : ?>
                                             ...
                                             <li>
                                                 <div class="cart-widget">
                                                     <div class="dz-media me-3">
                                                         <img src="<?php echo ASSETS_URL_ROOT . '/public/upload/' ?><?php echo $wishlist['product_image']  ?>" alt="">
                                                     </div>
                                                     <div class="cart-content">
                                                         <h6 class="title"><a href="product-thumbnail.html"><?php echo $wishlist['product_name']; ?></a>
                                                         </h6>
                                                         <div class="d-flex align-items-center">
                                                             <h6 class="dz-price text-primary mb-0">
                                                     ...
                                                     <a href="<?php echo url('wishlist/delete/' . $wishlist['id']); ?>" class="dz-close">
                                                         <i class="ti-close"></i>
                                                     </a>
                                                 </div>
                                             </li>
         ...
         <div class="col-lg-3">
             <div class="header-nav h-100  nav-dark">
                 <ul class="nav navbar-nav dark-nav">
                     ...
                     <li><a href="<?php url('order') ?>">Đơn hàng </a></li>
                 </ul>
             </div>
         </div>
     </div>

         ...
         <div class="main-bar clearfix">
             <div class="container-fluid clearfix">
                 ...
                 <div class="logo-header me-5">
                     <a href="index.html">
                         <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>logo.png" alt="logo" class="logo-dark">
                         <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>logo.png" alt="logo" class="logo-light">
                     </a>
                 </div>
                 <!-- EXTRA NAV -->
                 <div class="extra-nav">
